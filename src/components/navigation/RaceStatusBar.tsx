...
const countries: Country[] = [
  {
    ...
    deadline: new Date(
      Date.now() + 28 * 3600 * 1000 + 46 * 60 * 1000 + 6 * 1000
    ),
  ...
  },
  {
    code: "fr",
    name: "France",
    flag: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Flag_of_France.png/1280px-Flag_of_France.png",
...
export function RaceStatusBar() {
  ...
  const [timer, setTimer] = useState<Timer>(
    getTimeRemaining(selectedCountry.deadline)
  );
